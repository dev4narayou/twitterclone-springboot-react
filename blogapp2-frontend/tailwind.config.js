...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // background colors
        "twitter-black": "#000000", // main background (black)
        "twitter-dark": "#16181c", // secondary background (dark gray)
        "twitter-hover": "rgba(255, 255, 255, 0.03)", // hover state

        // border colors
        "twitter-border": "#2f3336", // main borders

        // text colors
        "twitter-white": "#ffffff", // main text (white)
        "twitter-gray": "#71767b", // secondary text (gray)
